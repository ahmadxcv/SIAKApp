...
use App\Models\Coreui\Menurole;    
use App\Http\Menus\GetSidebarMenu;
use App\Models\Coreui\Menulist;
use App\Models\Coreui\Menus;
use App\Models\Coreui\MenusLang;
...
class MenuElementController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('coreui.editmenu.index', array(
    ...
    public function create(){
        return view('coreui.editmenu.create',[
            'roles'    => RolesService::get(),
            'menulist' => Menulist::all(),
        ]);
    }
    ...
    public function edit(Request $request){
        ...
        return view('coreui.editmenu.edit',[
            'roles'    => RolesService::get(),
            'menulist' => Menulist::all(),
    ...
    public function show(Request $request){
        ...
        return view('coreui.editmenu.show',[
            'menulist' => Menulist::all(),
    ...
    public function delete(Request $request){
        ...
        return view('layouts.shared.universal-info');
    }
