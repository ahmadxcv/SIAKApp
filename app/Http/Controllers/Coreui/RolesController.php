...
use App\Models\Coreui\RoleHierarchy;
...
class RolesController extends Controller
{
    ...
    {
        return view('coreui.roles.index', array(
            'roles'      => Role::all(),
    ...
    {
        return view('coreui.roles.create');
    }
    ...
    {
        return view('coreui.roles.show', array(
    ...
    {
        return view('coreui.roles.edit', array(
            'role' => Role::where('id', '=', $id)->first()
        ));
    }
