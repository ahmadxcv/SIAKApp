...
use App\Models\Penduduk\Gantikk;
use App\Models\Penduduk\Lampiran;

use Auth;
use DB;

class GantikkController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('penduduk.gantikk',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('pengajuan/gantikk')->with('success','Data Berhasil Disimpan!');
    }
