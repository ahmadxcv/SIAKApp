...
use App\Models\Penduduk\Editkk;
use App\Models\Penduduk\Lampiran;

use Auth;
use DB;

class EditkkController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('penduduk.editkk',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $post2->ubah = $request->input('ubah');
        $post2->data_lama = $request->input('data_lama');
        $post2->data_baru = $request->input('data_baru');
        ...
        return redirect('pengajuan/editkk')->with('success','Data Berhasil Disimpan!');
    }
