...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/serviceworker.js', {
            ...
            console.log('SIAKApp PWA: ServiceWorker registration successful with scope: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('SIAKApp PWA: ServiceWorker registration failed: ', err);
        });
    }
</script>