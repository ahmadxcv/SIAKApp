...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
	...
	<i class="fa fa-align-justify"></i> {{ __('Pengajuan Mutasi KK') }}</div>
	<div class="card-body">
	<form method="POST" action="{{ route('simpanMutasi') }}" enctype="multipart/form-data"  id="Formulir">
		@csrf
		...
		<input type="text" class="form-control" id="nama" placeholder="Enter Nama" name="nama_lengkap" required>
		</div>
